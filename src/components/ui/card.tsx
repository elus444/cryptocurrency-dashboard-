  ...
  "rounded-xl text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        feature: "bg-card/40 backdrop-blur-xl border border-border/30 hover:border-primary/30 hover:bg-card/60",
        gradient: "bg-gradient-to-br from-card/60 to-card/30 backdrop-blur-xl border border-border/30",
      },
    },
    defaultVariants: {
      variant: "default",
